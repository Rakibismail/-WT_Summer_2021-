function validateForm() 
{
    ...
    if (fname == "") 
    {
     document.getElementById("err-fname").innerHTML="Please fillup your name";
      return false;
    }
    if(email == "")
    {
    ...
    if (pass == "") {
     document.getElementById("err-pass").innerHTML="Enter your password";
      return false;
    }else if(pass.length < 4)
    {
        document.getElementById("err-pass").innerHTML="Password have to 4 character ";
    }
    ...
    document.getElementById("err-chkbox").innerHTML="Please select ";
        return false;
    }
    if (file == "") 
    {
        document.getElementById("err-file").innerHTML="upload  file";
        return false;
    }
